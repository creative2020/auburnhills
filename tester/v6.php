...
<body>
 ...
 <table width="980" border="0" align="center" cellpadding="10" cellspacing="0" bgcolor="#FFFFFF">
   <tr>
     <td><p align="center" class="style7">Easy PHP Calendar Version 6
       </p>
       ...
       <table width="800" border="0" align="center" cellpadding="10" cellspacing="0">
         <tr>
           <td bgcolor="#99FF66"><p><strong>Instructions - Please Read!</strong></p>
             <p>For a server to be compatible with  <strong>Easy PHP Calendar  6</strong>:</p>
             <p>1) It must pass the PHP Version and Sessions Support test.  </p>
           <p> 2) It must either pass the Zend <em><strong>OR</strong></em> ionCube Loader test (it does NOT need to pass both).</p></td>
         </tr>
       </table>
       <br>
       <div align="center" class="style7"><strong><a href="v6php.php" class="style13">1) Continue to PHP Version and Sessions Support Test</a></strong><br>
         <br>
       </div>
