       ...
       <table width="800" border="0" align="center" cellpadding="10" cellspacing="0">
         <tr>
           <td bgcolor="#99FF66"><p><strong>Instructions - Please Read!</strong></p>
             <p>For a server to be compatible with  <strong>Easy PHP Calendar  7.1.X</strong>:</p>
             <p>1) It must pass the PHP Version test.  </p>
           <p> 2) It must  pass the ionCube Loader test.</p></td>
         </tr>
       </table>
       <br>
       <div align="center" class="style7"><strong><a href="v71Xphp.php" class="style13">&gt;&gt; Continue to PHP Test &lt;&lt;</a></strong><br>
         <br>
       </div>
