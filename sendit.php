 ...
 ***  Visit www.tectite.com for free <a href="http://www.tectite.com/">html form processor</a>.
 *
...
$TARGET_EMAIL = array(EMAIL_NAME."@auburnhillspools\.com$",
		EMAIL_NAME."@visionsmm\.com$",
		"^info@auburnhillspools\.com$",
		"^visions@visionsmm\.com$");

            /* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","admin@2020creative.com");
...
$PEAR_SMTP_HOST = "smtp.secureserver.net";
$PEAR_SMTP_PORT = 587;
$PEAR_SMTP_USER = "form@2020creative.email";
$PEAR_SMTP_PWD = "Iq4t68q2bPhbgw";
...
define("ATTACK_DETECTION_MANY_URLS",4);
